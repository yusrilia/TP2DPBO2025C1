...
<body>    
    ...
    <?php $listBaju[] = new Baju($idCounter++, "Jaket Santai", 58000, 2, "images/image.jpg", "Kaos", "denim", "Hitam", "Anjing", 3, "DogNikey"); ?>
    <?php $listBaju[] = new Baju($idCounter++, "Hoodie Puppy", 38000, 5, "images/image.jpg", "Baju", "Fleece", "Chrome Silver", "Puppy", 3, "DolceDogana"); ?>
    
    
    <h2>Daftar Baju (After)</h2>
    <table>
        <tr>
            <th>ID</th>
            <th>Nama Produk</th>
